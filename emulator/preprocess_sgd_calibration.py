...
input_df = pd.read_pickle(
    "~/EMOD-calibration/simulations/sgd_calibration_input_data_full.pkl"
)
...
incidence_scale_df.to_csv(
    "~/EMOD-calibration/simulations/download/incidence_scaling_sgd_calibration.csv"
)
...
full_df.to_pickle("~/EMOD-calibration/emulator/scaled_df_sgd_calibration.pkl")
