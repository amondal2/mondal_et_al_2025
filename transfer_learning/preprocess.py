"""
Preprocess script for transfer learning emulator.
"""
import os.path
import pandas as pd
...
eir_df = pd.read_csv(
    os.path.expanduser("~/EMOD-calibration/simulations/site_eirs_and_interventions.csv")
)
input_df = input_df.merge(eir_df, on="Site")
# Tokenize Sites
...
static_params = ["has_interventions", "Site", "sim_id"]
...
param_mins.to_csv("~/EMOD-calibration/simulations/download/param_mins_transfer.csv")
param_max.to_csv("~/EMOD-calibration/simulations/download/param_max_transfer.csv")

input_df_scaled = input_df[train_params]

input_df_scaled["Site"] = input_df["Site"]
input_df_scaled["sim_id"] = input_df["sim_id"]
input_df_scaled["has_interventions"] = input_df["has_interventions"]
...
incidence_scale_df.to_csv(
    "~/EMOD-calibration/simulations/download/incidence_scaling_transfer.csv"
)
...
full_df.to_pickle("~/EMOD-calibration/transfer_learning/scaled_df.pkl")
